...
$stmt2= mysqli_prepare($conn2, "insert into reg(User,Name,Gender,DOB,Father,Mother,Present,Permanent,Mobile,Email,Password) values(?,?,?,?,?,?,?,?,?,?,?)");
...
<body background="../model/white.jpg">
  <center><font color="black"> <h1>  SIGNUP PAGE<h1></font></center>
    <br>
